...
def data_argumentation():
    ...
    pixels = data_d['pixels'].apply(lambda x: np.array(x.split(), dtype='float32'))
    ...
    for i in range(pixels.shape[0]):
        ...
        Image.fromarray(x[0].squeeze()).convert('L').save(f"data/fer2013/images/aug_{data['emotion'][i]}_{data['Usage'][i]}.jpeg")
